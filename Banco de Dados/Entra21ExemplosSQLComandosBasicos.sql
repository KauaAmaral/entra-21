CREATE TABLE trabalhos(
	...
	titulo VARCHAR(100), -- Armazenar até 100 caracteres
...
INSERT INTO trabalhos
	...
	'Como degustar um pizza de calabresa',
...
INSERT INTO trabalhos
	...
	'Compre frango e batata palha, jogue na panela, acenda o fogão, espera 5 minutinhos e ta plonto o sorvetinho',
	'2000-09-10',
	'Receita');

SELECT 
	id, titulo , subtitulo, descricao, data_publicacao, tipo
	FROM trabalhos;
...
SELECT
	...
	YEAR(data_publicacao) <= 2012;

-- Apresentar data publicada formato BR huehue
-- BR: dia/mes/ano
SELECT
	id, titulo,
	CONCAT(
...
SELECT
	id, titulo,
	FORMAT(data_publicacao, 'dd/MM/yyyy')
	FROM trabalhos;
...
-- Apresentar o código, nome, preço, se está favoritado filtrando por Placa mãe ou Placa do maior preco para o menor
-- SELECT
--	TOP(20) id , nome, preco, favoritado
--	FROM produtos
