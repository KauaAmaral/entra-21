...
--Tabela de pokemons:
--Utilize o arquivo pokemons_estrutura_insert.sql. Execute este arquivo antes de começar a resolver os exercícios
--abaixo.

--1. Selecione todas as colunas.
SELECT id, nome, codigo, categoria, altura, peso, hp, ataque, defesa, especial_ataque, especial_defesa,
...
SELECT nome, LEN(nome) AS 'Tamanho do nome'
	FROM pokemons
	ORDER BY nome DESC;
...
SELECT SUM(ataque) / COUNT(ataque) AS 'Media dos Ataques'
	FROM pokemons;

--11. Selecione a somatória dos ataques.
SELECT SUM(ataque) AS 'Soma dos Ataques'
	FROM pokemons;
