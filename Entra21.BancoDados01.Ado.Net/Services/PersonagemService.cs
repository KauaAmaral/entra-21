...
namespace Entra21.BancoDados01.Ado.Net.Services
{
    internal class PersonagemService : IPersonagemService
    {
        public void Apagar(int id)
        {
            ...
            // Substituir os @ no comando da query qye sera executada no banco de dados, previnindo SQL Injection
        ...
        public Personagem ObterPorId(int id)
        {
            ...
            // Substituir o @ do comando do SELECT com id
            comando.Parameters.AddWithValue("@ID", id);
...
INNER JOIN editoras AS e ON(p.id_editora = e.id)";
            ...
            // Criado a tabela na memoria para armazenar os registros do SELECt
